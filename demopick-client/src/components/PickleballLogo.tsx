  ...
  return (
    ...
    >
      <defs>
        ...
        <linearGradient id="whitePaddleGradComp" x1="18" y1="6" x2="63" y2="56" gradientUnits="userSpaceOnUse">
          <stop offset="0%" stopColor="#FFFFFF" />
          <stop offset="100%" stopColor="#F1F5F9" />
        </linearGradient>

        {/* Yellow Pickleball Gradient */}
        <linearGradient id="yellowBallGradComp" x1="54" y1="40" x2="84" y2="70" gradientUnits="userSpaceOnUse">
        ...
        {/* Handle Gradient */}
        <linearGradient id="handleGradComp" x1="34" y1="54" x2="47" y2="92" gradientUnits="userSpaceOnUse">
          <stop offset="0%" stopColor="#334155" />
          <stop offset="100%" stopColor="#0F172A" />
        </linearGradient>

        {/* Drop Shadow Filter */}
        <filter id="softShadowComp" x="-20%" y="-20%" width="140%" height="140%">
          <feDropShadow dx="0" dy="2.5" stdDeviation="2.5" floodColor="#000000" floodOpacity="0.25"/>
        </filter>
      </defs>

      <g filter="url(#softShadowComp)">
        ...
        <g>
          {/* Ball Body */}
          <circle cx="69" cy="55" r="16.5" fill="url(#yellowBallGradComp)" stroke="#B45309" strokeWidth="1.2" />
