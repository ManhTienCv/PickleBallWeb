            ...
            <div className="space-y-8 font-sans">
              ...
              <div className="flex flex-wrap items-center gap-2 p-3 bg-slate-50 dark:bg-slate-900/60 rounded-2xl border border-slate-200/80 dark:border-border">
                ...
                <button
                  ...
                  className={`px-3 py-1.5 rounded-xl text-xs font-bold border transition-colors duration-150 cursor-pointer ${selectedStarFilter === 'all'
                ...
                {[5, 4, 3, 2, 1].map((star) => {
                  ...
                  return (
                    <button
                      ...
                      className={`px-3 py-1.5 rounded-xl text-xs font-bold border transition-colors duration-150 flex items-center gap-1 cursor-pointer ${selectedStarFilter === star
                          ? 'bg-emerald-600 text-white border-emerald-600 shadow-sm'
                          : 'bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-200 border-slate-200 dark:border-slate-700 hover:bg-slate-100 dark:hover:bg-slate-700'
                        }`}
                    >
                ...
                <button
                  ...
                  className={`px-3 py-1.5 rounded-xl text-xs font-bold border transition-colors duration-150 flex items-center gap-1.5 cursor-pointer ${selectedStarFilter === 'with_image'
                      ? 'bg-emerald-600 text-white border-emerald-600 shadow-sm'
                      : 'bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-200 border-slate-200 dark:border-slate-700 hover:bg-slate-100 dark:hover:bg-slate-700'
                    }`}
                >
